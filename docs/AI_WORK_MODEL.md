...
1. 阅读 `README.md`（工具使用说明）与 `docs/AI_WORK_MODEL.md`（协作模板体系）了解项目背景与状态
...
```
.
├── README.md              ← qrcd 工具使用说明
├── docs/                  ← 项目文档
│   ├── 00_idea.md … 09_test_report.md   ← PRD/架构/API/任务/决策/审查/测试
│   ├── AI_WORK_MODEL.md   ← AI 协作模板体系（本文件，原 README）
│   └── CHANGELOG.md
├── .ai/                   ← AI 协作配置
│   ├── roles/             ← 角色定义
│   │   ├── pm.md
